...
('1Le', '1', 'Continuo', 'Hola...'),
('1Le', '2', 'Pregunta', 'Acuérdese que tiene que hacer examen eh'),
('1Le', '3', 'Pregunta', '¿Como va?'),
('1Le', '4', 'Final', '¿Listo? Adiós '),
('1Es', '1', 'Continuo', '¿Que? ¿Como están jóvenes?'),
('1Es', '2', 'Pregunta', 'Miren les voy a aplicar un examen ¿cómo ven?'),
('1Es', '3', 'Pregunta', '¡Animo! ya casi acaba'),
('1Es', '4', 'Final', '¿Qué tal como estuvo el examen, fácil no?'),
('1Ma', '1', 'Continuo', '¿Qué tal jóvenes? ¿como están?'),
('1Ma', '2', 'Pregunta', 'Les voy a aplicar examen el día de hoy ¿verdad?'),
('1Ma', '3', 'Pregunta', '¿Que? ¿Como va?'),
('1Ma', '4', 'Final', '¿Ya acabo? ¿verdad que estaba fácil el examen?');

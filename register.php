    ...
    <div class="auth-card">
        ...
        <?php if (!$exito): ?>
            <div class="social-auth">
                <button class="btn-social" onclick="window.location='auth_provider.php?provider=google'">Google</button>
                <button class="btn-social" onclick="window.location='auth_provider.php?provider=github'">GitHub</button>
            </div>

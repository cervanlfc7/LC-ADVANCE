...
- [public/docs/DEVELOPMENT.md](public/docs/DEVELOPMENT.md) - Arquitectura y desarrollo
- [public/docs/API.md](public/docs/API.md) - Endpoints y referencias
- [public/docs/TROUBLESHOOTING.md](public/docs/TROUBLESHOOTING.md) - Soluciones a problemas
...
```bash
# Windows (XAMPP)
c:\xampp\mysql\bin\mysql.exe -u root -p < src\Database\lc_advance.sql

# macOS/Linux
mysql -u root -p < src/Database/lc_advance.sql
```

**Nota:** El archivo `src/Database/lc_advance.sql` incluye automáticamente:
...
- 🗺️ Mapa: http://localhost/LC-ADVANCE/public/mapa/index.php
- 📊 Dashboard: http://localhost/LC-ADVANCE/public/dashboard.php (requiere login)
...
Ver documentación completa en [public/docs/API.md](public/docs/API.md)

**Endpoints principales:**

- `POST /login.php` - Autenticación
- `GET /leccion_detalle.php?slug=...&materia=...` - Ver lección
- `POST /src/Core/funciones.php` - Calificar quiz (accion=calificar_quiz)
- `POST /src/Core/funciones.php` - Obtener estado (accion=obtener_estado)
- `POST /public/mapa/updateDB.php` - Actualizar maestro del mapa

Ver [public/docs/API.md](public/docs/API.md) para ejemplos curl y respuestas JSON detalladas.

---

## Cómo Agregar Lecciones

### 1️⃣ Editar `src/Content/content.php`
...
**Ver soluciones detalladas en [public/docs/TROUBLESHOOTING.md](public/docs/TROUBLESHOOTING.md)**
...
Ver [public/docs/TROUBLESHOOTING.md](public/docs/TROUBLESHOOTING.md) para soluciones completas.
...
Ver [public/docs/DEVELOPMENT.md](public/docs/DEVELOPMENT.md) para más detalles de arquitectura y deployment.
...
| **[public/docs/DEVELOPMENT.md](public/docs/DEVELOPMENT.md)**         | Arquitectura, cómo agregar funcionalidades |
| **[public/docs/API.md](public/docs/API.md)**                         | Endpoints, ejemplos curl, respuestas JSON  |
| **[public/docs/QUICK_REFERENCE.md](public/docs/QUICK_REFERENCE.md)** | Cheat sheet y comandos rápidos             |
| **[public/docs/TROUBLESHOOTING.md](public/docs/TROUBLESHOOTING.md)** | Soluciones a problemas comunes             |
